	    ...
	    $results = $sql->select("
	     ...
	     else
	     {
	         ...
	         else
	         {
	             ...
	             if ($inadmin === true) {
	                 $link = "http://www.latrus.com.br/admin/forgot/reset?code=$result";
	             } else {
	                 $link = "http://www.latrus.com.br/forgot/reset?code=$result";
	             } 
	             $mailer = new Mailer($data['desemail'], $data['desperson'], "Redefinir senha da Latrus Store", "forgot", array(
	                 "name"=>$data['desperson'],
	                 "link"=>$link
	             )); 
	             $mailer->send();
